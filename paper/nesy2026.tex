...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{figures/figure-2-performance-ci.pdf}
\caption{Held-out Brier scores with 95\% bootstrap confidence intervals. Lower values are better. The transformer variants are close, so small point-estimate differences should be interpreted together with paired-bootstrap comparisons.}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{figures/figure-3-rule-firing.pdf}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{figures/figure-4-case-trace.pdf}
